          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  "The ${Provider.of<planet_provider>(context, listen: false).planet_details[8].name}",
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                "${Provider.of<planet_provider>(context).planet_details[8].name}",
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                "${Provider.of<planet_provider>(context).planet_details[8].velocity}",
                                style: GoogleFonts.inter(
                                  textStyle: TextStyle(
                                    fontSize: 44,
                                    color: Colors.white,
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                "${Provider.of<planet_provider>(context).planet_details[8].distance}",
                                style: GoogleFonts.inter(
                                  textStyle: TextStyle(
                                    fontSize: 44,
                                    color: Colors.white,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(
                              "${Provider.of<planet_provider>(context).planet_details[8].description}",
                              style: GoogleFonts.inter(
                                textStyle: TextStyle(
                                  fontSize: 16,
                                  color: Colors.white,
